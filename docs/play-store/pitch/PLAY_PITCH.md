...
- `pitch/panels/01-your-music-alive.png`
- `pitch/panels/02-thirty-two-visions.png`
- `pitch/panels/03-local-offline-yours.png`
- `pitch/panels/04-cockpit-for-sound.png`
- `pitch/panels/05-made-strange.png`

## Hero

- `pitch/github-hero-1600x600.png`

## Overview

- `pitch/pitch-contact-sheet.png`
